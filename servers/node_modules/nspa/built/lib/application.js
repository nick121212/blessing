...
var SpaServer = exports.SpaServer = function (_SpaRouter) {
    ...
    function SpaServer(config, events) {
    ...
    (0, _createClass3.default)(SpaServer, [{
        ...
        value: function init(config) {
            ...
            this._server.on("disconnect", function (connection) {
                var connectionObject = _this4._connections[connection.id];

                if (_this4._connections[connection.id]) {
                    delete _this4._connections[connection.id];
                }
                _this4.emit("ondisconnect", connection, connectionObject);
            });
            return this._server;
        }
    }, {
...
var SpaClient = exports.SpaClient = function (_SpaRouter2) {
    ...
    function SpaClient(config, events) {
...
var Spa = exports.Spa = function (_Compose) {
    ...
    (0, _createClass3.default)(Spa, [{
        ...
        key: "initClient",
        value: function initClient(config, events) {
            this.spaClient = new SpaClient(config, events);
        }
    }, {
        key: "initServer",
        value: function initServer(config, app, events) {
