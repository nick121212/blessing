...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageExecuteCmdResultController = (function () {
	    function PageExecuteCmdResultController($scope, fxAction, sockets, $q, $timeout, toolbarUtils, materialUtils) {
	        ...
	        if (this.realTime) {
	            ...
	            this.$scope.$on("socket:events", function (event, msg) {
	                ...
	                _this.setProcess(msg._source.success);
	            });
	        }
	    ...
	    PageExecuteCmdResultController.prototype.setProcess = function (success) {
	        ...
	        this.process.complete = (this.process.success + this.process.fail) / this.process.total;
	        this.process.buffer = (this.process.success + this.process.fail) / this.process.total;
	    };
...
//# sourceMappingURL=0.89a78b45a052f5560b67.hot-update.js.map