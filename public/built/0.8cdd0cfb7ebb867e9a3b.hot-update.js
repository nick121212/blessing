	...
	var Builder = (function () {
	    ...
	    Builder.prototype.init = function () {
	        ...
	        if (this.form.acOptions.keyField) {
	            if (pointer.has(viewModel, "/" + this.form.acOptions.keyField)) {
	                this.searchText = pointer.get(viewModel, "/" + this.form.acOptions.keyField);
	            }
	            return;
	        }
	        if (pointer.has(this.formData, "/" + this.form.acOptions.keyField)) {
	        }
...
//# sourceMappingURL=0.8cdd0cfb7ebb867e9a3b.hot-update.js.map