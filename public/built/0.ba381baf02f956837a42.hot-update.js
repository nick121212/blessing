	...
	function Provider() {
	    ...
	    var Builder = (function () {
	        ...
	        Builder.prototype.onChange = function (item, form) {
	            ...
	            config.sfSelect(this.form.key, item, this.formData);
	    ...
	    this.builder = function (args) {
	        ...
	        args.form.ACBoost = function (form, modelValue, formData) {
	            console.log(args);
	            return new Builder(form, modelValue, formData);
	        };
	    };
...
//# sourceMappingURL=0.ba381baf02f956837a42.hot-update.js.map