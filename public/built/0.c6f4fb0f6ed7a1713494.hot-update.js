...
/***/ function(module, exports, __webpack_require__) {
	...
	var SidenavLeftController = (function () {
	    function SidenavLeftController(mdSideMenuSections, toolbarUtils, fxAction, $state, fxSideMenuFactory) {
	    ...
	    SidenavLeftController.prototype.getModules = function () {
	        ...
	        promise && promise.then(function (results) {
	            ...
	            _this.fxSideMenuFactory.onStateChangeStart(null, _this.$state.current, null);
	        });
	    };
	    ...
	    SidenavLeftController.$inject = ["mdSideMenuSections", "toolbarUtils", "fxAction", "$state", "fxSideMenuFactory"];
...
//# sourceMappingURL=0.c6f4fb0f6ed7a1713494.hot-update.js.map