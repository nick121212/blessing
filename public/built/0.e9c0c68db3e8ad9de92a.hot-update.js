...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<input name=\"{{::form.key|sfCamelKey}}\" ng-model=\"$$value$$\" schema-validate=\"form\" sf-changed=\"form\" class=\"ng-hide\">");
	jade_debug.shift();
	jade_debug.unshift(new jade.DebugItem( 32, "/srv/blessing/public/src/directives/action/decorators/autocomplete-1.jade" ));
	buf.push("<span name=\"{{::form.key|sfCamelKey}}\" ng-init=\"boost = form.ACBoost(form,$$value$$,model);\" sf-field-model=\"replaceAll\" ng-model=\"$$value$$\" class=\"nd-hide\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</span>");
	jade_debug.shift();
...
//# sourceMappingURL=0.e9c0c68db3e8ad9de92a.hot-update.js.map