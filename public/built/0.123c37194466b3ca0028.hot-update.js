...
/***/ function(module, exports, __webpack_require__) {
	...
	var SidenavLeftController = (function () {
	    function SidenavLeftController(mdSideMenuSections, toolbarUtils, fxAction, $state) {
	    ...
	    SidenavLeftController.prototype.doLink = function ($event, node) {
	        this.$state.go(node.state, node.key);
	    };
	    SidenavLeftController.$inject = ["mdSideMenuSections", "toolbarUtils", "fxAction", "$state"];
...
//# sourceMappingURL=0.123c37194466b3ca0028.hot-update.js.map