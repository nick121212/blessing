	...
	var Force = (function () {
	    ...
	    Force.prototype.doZoom = function () {
	        ...
	        this.zoom = d3.zoom()
	            ...
	            .duration(400)
	            .on("zoom", function () {
	            _this.container.select(".card").style("transform", "scale(" + d3.event.transform.k + ") translate(" + d3.event.transform.x + "px," + d3.event.transform.y + "px)");
	        });
	        this.container.call(this.zoom);
	    };
	    Force.prototype.doDraw = function () {
	        var width = innerWidth, height = innerHeight;
	        var cards = this.container.selectAll(".card")
	            .style("width", "200px")
...
//# sourceMappingURL=0.7b26fc13fbc970500d46.hot-update.js.map