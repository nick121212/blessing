...
/***/ function(module, exports, __webpack_require__) {
	...
	var Force1 = (function () {
	    ...
	    Force1.prototype.doDraw = function () {
	        ...
	        this.simulation = d3.forceSimulation(this.nodes)
	            ...
	            .force("charge", d3.forceManyBody().strength(-5000).theta(200))
	...
	var Force = (function () {
	    ...
	    Force.prototype.doDraw = function () {
	        ...
	        this.simulation = d3.forceSimulation(this.nodes)
	            .force("link", d3.forceLink(this.links || []))
	            .force("charge", d3.forceManyBody().strength(-500).distanceMin(200))
	        ...
	        this.cardContainer
	            ...
	            .append("span")
	            .attr("class", "card")
	            .text(function (d) { return d.ttile; });
	        this.cardContainer
	            .selectAll(".card")
	            .call(d3.drag()
	            .on("start", function (d) {
...
//# sourceMappingURL=0.c70f92759c6edca200fc.hot-update.js.map