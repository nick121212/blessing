	            ...
	            var directive = {
	                ...
	                link: function ($scope, $element, $attrs, ngModel) {
	                    ngModel.$validators['compareTo'] = function (modelValue, viewValue) {
	                        if ($scope["compareForm"] && $scope["compareTo"]) {
	                        }
	                        return true;
	                        console.log($scope["compareForm"]);
	                        return normal_1.compare.doCompare(modelValue, "", $scope["compareType"] || "", $scope["compareOpt"] || "eq");
	                    };
	                    console.log(ngModel);
	                }
	            };
...
//# sourceMappingURL=0.659f4a730ca4419c9678.hot-update.js.map