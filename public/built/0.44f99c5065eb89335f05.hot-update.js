...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div fx-list-action key=\"{{pageCtl.key}}\" flex multiple=\"false\" auto-select=\"true\" local=\"true\" client-data=\"qtCtl.clientData\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</div>");
	jade_debug.shift();
	...
	jade_debug.shift();;return buf.join("");
	  ...
	  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "md-content(flex,layout=\"column\")\n    md-card()\n        md-card-title\n            h1 命令详情\n        md-card-content\n            h1 hello \n    md-card\n        md-card-title\n            h1 机器列表\n        md-card-content\n            div(fx-list-action,key=\"{{pageCtl.key}}\",flex,multiple=\"false\",auto-select=\"true\",local=\"true\",client-data=\"qtCtl.clientData\")");
	}
	}
...
//# sourceMappingURL=0.44f99c5065eb89335f05.hot-update.js.map