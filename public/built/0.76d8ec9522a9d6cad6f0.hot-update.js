	...
	var PageExecuteCmdResultController = (function () {
	    ...
	    PageExecuteCmdResultController.prototype.filterDeviceSn = function () {
	        if (this.deviceSelected.length) {
	            return {
	                _source: {
	                    deviceSn: _.map(this.deviceSelected, function (item) {
	                        return item._source.deviceSn;
	                    })
	                }
	            };
	        }
	        ...
	        this.$timeout(function () {
	            ...
	            _this.$q.all([
	                ...
	                if (_this.cmdClientData.rows.length) {
	                    ...
	                    _this.deviceClientData.rows.length && (_this.deviceSelected = [_this.deviceClientData.rows]);
	                }
	                else {
...
//# sourceMappingURL=0.76d8ec9522a9d6cad6f0.hot-update.js.map