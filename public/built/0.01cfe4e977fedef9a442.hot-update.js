	        ...
	        var actionModel = {
	            ...
	            list: {
	                columns: [
	                    ...
	                    actionUtils.columnBuilder("<span>{{ ::item.address }}</span>", "请求类型").toValue(),
	                    actionUtils.columnBuilder("<span>{{ ::item.port }}</span>", "请求类型").toValue(),
	                    actionUtils.columnBuilder("<span>{{ ::item.path }}</span>", "请求类型").toValue(),
	                    actionUtils.columnBuilder("<span>{{ ::item.jpp }}</span>", "请求类型").toValue(),
	                    actionUtils.columnBuilder("<span>{{ ::item.isRestful }}</span>", "请求类型").toValue(),
...
//# sourceMappingURL=0.01cfe4e977fedef9a442.hot-update.js.map