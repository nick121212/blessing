	...
	var Controller = (function () {
	    ...
	    Controller.prototype.initSearchToolbar = function () {
	        ...
	        this.toolbars = [
	            ...
	            this.toolbarUtils.btnBuilder("清空搜索条件", "md-icon-button").iconBuilder("clear_all").btnClick(function ($event) {
	                _this.clearFilterData();
	            }).toValue(),
	            this.toolbarUtils.btnBuilder("关闭搜索栏", "md-icon-button").iconBuilder("{{searchCtl.isShow?'window-open':'window-closed'}}").btnClick(function ($event) {
...
//# sourceMappingURL=0.1eabf1f11606005bc76d.hot-update.js.map