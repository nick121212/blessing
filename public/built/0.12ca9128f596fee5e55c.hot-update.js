...
/***/ function(module, exports) {
	...
	var PageExecuteCmdController = (function () {
	    ...
	    PageExecuteCmdController.prototype.doInitToolbar = function () {
	        this.toolbars = [
	            this.toolbarUtils.btnBuilder("执行命令", "md-icon-button", false).iconBuilder("apple-keyboard-command", {}).btnClick(function ($event) {
	            }).toValue()
	        ];
	    };
...
//# sourceMappingURL=0.12ca9128f596fee5e55c.hot-update.js.map