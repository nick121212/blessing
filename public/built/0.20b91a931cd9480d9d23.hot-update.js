...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-card style=\"width:150px;\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	...
	buf.push("In-card mixed actions");
	jade_debug.shift();
	jade_debug.shift();
	buf.push("</span>");
	jade_debug.shift();
	...
	jade_debug.unshift(new jade.DebugItem( 8, jade_debug[0].filename ));
	buf.push("The titles of Washed Out's breakthrough song and the first single from Paracosm share the");
	jade_debug.shift();
	buf.push("\n");
	jade_debug.unshift(new jade.DebugItem( 8, jade_debug[0].filename ));
	buf.push("two most important words in Ernest Greene's musical language: feel it. It's a simple request, as well...");
	jade_debug.shift();
	jade_debug.shift();
	buf.push("</p>");
	jade_debug.shift();
...
//# sourceMappingURL=0.20b91a931cd9480d9d23.hot-update.js.map