...
/***/ function(module, exports, __webpack_require__) {
	...
	var Builder = (function () {
	    ...
	    Builder.prototype.init = function () {
	        ...
	        pointer.has(this.formData, "/" + this.form.acOptions.keyField) &&
	            this.onChange(pointer.get(this.formData, "/" + this.form.acOptions.keyField));
	    };
	    Builder.prototype.onChange = function (item, formData) {
	        if (formData === void 0) { formData = this.formData; }
	        this.selected = item;
	        if (_.isEmpty(item)) {
	            return pointer.set(formData, "/" + this.form.key.join('/'), item);
	        }
...
//# sourceMappingURL=0.797db08186b504a09f35.hot-update.js.map