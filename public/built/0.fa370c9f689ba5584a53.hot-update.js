...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils, $mdDialog, materialUtils) {
	        ...
	        }).toValue(), this.toolbarUtils.btnBuilder("关闭", "md-fab md-raised md-mini", false).iconBuilder("close", {}).btnClick(function ($event, item, index) {
	        }).toValue());
	    }
	    return Controller;
	}());
...
//# sourceMappingURL=0.fa370c9f689ba5584a53.hot-update.js.map