...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils, $mdDialog, materialUtils) {
	        ...
	        this.topToolbars.push(this.toolbarUtils.btnBuilder("清空所有选中数据", "md-icon-button", false).iconBuilder("clear_all", {}).disabledBuilder("").btnClick(function ($event, item, index) {
...
//# sourceMappingURL=0.10b79b7b89bff14987b5.hot-update.js.map