...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils, $mdDialog, materialUtils) {
	        ...
	        this.topToolbars.push(this.toolbarUtils.btnBuilder("清空所有选中数据", "md-icon-button", false).iconBuilder("clear_all", {}).conditionBuilder("").btnClick(function ($event, item, index) {
...
//# sourceMappingURL=0.3b6a65e857eb0f454ce2.hot-update.js.map