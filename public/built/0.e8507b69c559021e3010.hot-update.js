	...
	var Force = (function () {
	    ...
	    Force.prototype.doZoom = function () {
	        ...
	        this.zoom = d3.zoom()
	            ...
	            _this.container.select("svg").attr("transform", d3.event.transform);
	        });
	        this.container.call(this.zoom);
	    };
	    Force.prototype.doDrawEdges = function () {
	        this.svgEdges = this.container.append("svg")
	            .append("g")
	            .attr("class", "lines")
	            .selectAll("line")
	            .data(this.links)
	    ...
	    Force.prototype.doDraw = function () {
	        ...
	        this.simulation = d3.forceSimulation(this.nodes)
	            .force("link", d3.forceLink(this.links || []))
	            .force("charge", d3.forceManyBody().strength(-1000).theta(3))
...
//# sourceMappingURL=0.e8507b69c559021e3010.hot-update.js.map