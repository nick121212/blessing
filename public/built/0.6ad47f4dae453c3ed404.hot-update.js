	    ...
	    Provider.prototype.doAction = function (key, queryData, $form) {
	        ...
	        return this.getModel(key).then(function (aModel) {
	            ...
	            _.each(actionModel.interfaces, function (interfaceModel) {
	                ...
	                interfaceModel.config && restAngular.withHttpConfig(function (httpConfig) {
	                    httpConfig.data = interfaceModel.config;
	                });
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-dialog fx-dialog-form-action ng-model=\"dialogCtl.item\" key=\"{{dialogCtl.key}}\" flex-gt-sm=\"50\" flex=\"100\" ng-submit=\"dialogCtl.submit\">");
	...
	jade_debug.shift();;return buf.join("");
	  ...
	  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "md-dialog(fx-dialog-form-action,ng-model=\"dialogCtl.item\",key=\"{{dialogCtl.key}}\",flex-gt-sm=\"50\",flex=\"100\",ng-submit=\"dialogCtl.submit\")\n");
	}
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-dialog fx-dialog-wizard-action ng-model=\"dialogCtl.item\" key=\"{{dialogCtl.key}}\" flex-gt-sm=\"50\" flex=\"100\" ng-submit=\"dialogCtl.submit\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</md-dialog>");
	jade_debug.shift();
	jade_debug.shift();;return buf.join("");
	  ...
	  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "md-dialog(fx-dialog-wizard-action,ng-model=\"dialogCtl.item\",key=\"{{dialogCtl.key}}\",flex-gt-sm=\"50\",flex=\"100\",ng-submit=\"dialogCtl.submit\")\n");
	}
	}
...
//# sourceMappingURL=0.6ad47f4dae453c3ed404.hot-update.js.map