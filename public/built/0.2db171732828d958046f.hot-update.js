...
/***/ function(module, exports, __webpack_require__) {
	...
	var common_value_1 = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pointer = __webpack_require__(43);
	...
	var Provider = (function () {
	    function Provider($rootScope, $injector, restUtils, mdUtils, $q, $mdDialog) {
	        ...
	        this.$get = ["$rootScope", "$injector", "restUtils", "materialUtils", "$q", "$mdDialog", function () {
	                return new (Provider.bind.apply(Provider, [void 0].concat(arguments)))();
	            }];
	    }
	    ...
	    Provider.prototype.doActionModel = function ($event, actionModel, item, callback) {
	        ...
	        switch (actionModel.type) {
	            ...
	            case action_model_1.ActionType.form:
	                var templates = (_a = {},
	                    _a[action_model_1.ActionType.form] = __webpack_require__(45)(),
	                    _a[action_model_1.ActionType.wizard] = __webpack_require__(46)(),
	                    _a
	                );
...
//# sourceMappingURL=0.2db171732828d958046f.hot-update.js.map