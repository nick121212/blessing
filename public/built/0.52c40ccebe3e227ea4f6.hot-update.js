	    ...
	    Provider.prototype.getSchema = function (actionModel) {
	        ...
	        if (keys.length) {
	            this.getModel("schemaListAction").then(function (model) {
	                ...
	                if (actionModel.type === action_model_1.ActionType.form) {
	                    if (_.isString(actionModel.form.dataSchema) && schemas[actionModel.form.dataSchema]) {
	                        actionModel.form.dataSchema = schemas[actionModel.form.dataSchema]["text"];
	                    }
	                    if (_.isString(actionModel.form.formSchema) && schemas[actionModel.form.formSchema]) {
	                        actionModel.form.formSchema = schemas[actionModel.form.formSchema]["textForm"];
	                    }
	                }
	            }).finally(function () {
...
//# sourceMappingURL=0.52c40ccebe3e227ea4f6.hot-update.js.map