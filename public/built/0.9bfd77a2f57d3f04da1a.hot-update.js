...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.module.config(["sfErrorMessageProvider", function (sfErrorMessageProvider) {
	        ...
	        $templateCache.put('./decorators/jsoneditor.jade', __webpack_require__(45)());
	        $templateCache.put('./decorators/card.jade', __webpack_require__(46)());
	        $templateCache.put('./decorators/autocomplete-1.jade', __webpack_require__(47)());
	        $templateCache.put('./decorators/section-1.jade', __webpack_require__(48)());
	    }]);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    Provider.prototype.doActionModel = function ($event, actionModel, item, callback) {
	        ...
	        switch (actionModel.type) {
	            ...
	            case action_model_1.ActionType.form:
	                var templates = (_a = {},
	                    _a[action_model_1.ActionType.form] = __webpack_require__(54)(),
	                    _a[action_model_1.ActionType.wizard] = __webpack_require__(55)(),
	                    _a
	                );
	...
	module_1.module.provider(Provider._name, [Provider]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_.each(services, function (model) {
	    module_1.module.service(model.key, model);
	});
...
//# sourceMappingURL=0.9bfd77a2f57d3f04da1a.hot-update.js.map