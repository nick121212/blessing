...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div fx-list-action key=\"devices\" flex multiple=\"true\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</div>");
	jade_debug.shift();
	jade_debug.unshift(new jade.DebugItem( 8, "/srv/blessing/public/src/directives/query.table/tpls/query.table.jade" ));
	buf.push("<div fx-list-action key=\"devices\" flex local=\"true\" multiple=\"true\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</div>");
	jade_debug.shift();
	...
	jade_debug.shift();;return buf.join("");
	  ...
	  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "md-content(flex,column=\"column\")\n    md-toolbar.md-accent()\n        div.md-toolbar-tools\n            md-button 1\n            md-button 2\n            md-button 3\n    div(fx-list-action,key=\"devices\",flex,multiple=\"true\")\n    div(fx-list-action,key=\"devices\",flex,local=\"true\",multiple=\"true\")");
	}
	}
...
//# sourceMappingURL=0.a76d7cdb4d450bfb7621.hot-update.js.map