...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils) {
	        ...
	        this.toolbars.push(this.toolbarUtils.btnBuilder("删除", "md-fab md-raised md-mini", false).iconBuilder("{{qtCtl.layout=='column'?'toggle-switch':'toggle-switch-off'}}", {}).btnClick(function ($event, item, index) {
	            _this.clientData.rows.splice(index, 1);
	        }).toValue());
	    }
	    return Controller;
...
//# sourceMappingURL=0.f226695f9642e801b229.hot-update.js.map