...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils) {
	        ...
	        this.toolbars.push(this.toolbarUtils.btnBuilder("删除", "md-fab md-raised md-mini", false).iconBuilder("delete", {}).btnClick(function ($event, item, index) {
	            _this.clientData.rows.splice(index, 1);
	        }).toValue());
	    }
	    return Controller;
...
//# sourceMappingURL=0.53a26a2bc2a2df0596b0.hot-update.js.map