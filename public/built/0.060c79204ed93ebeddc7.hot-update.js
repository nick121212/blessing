...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.module = angular.module(_name + "Module", [ngMaterial, rest_service_1.default, "schemaForm", "ng.jsoneditor"])
	    ...
	    .config(["sfBuilderProvider", "schemaFormDecoratorsProvider", "jsonEditorBuilderProvider", "autoCompleteBuilderProvider", "layoutBuilderProvider", function (sfBuilderProvider, schemaFormDecoratorsProvider, jsonEditorBuilder, autoCompleteBuilder, layoutBuilder) {
	        ...
	        schemaFormDecoratorsProvider.defineAddOn('materialDecorator', 'modandact', "./decorators/modandact.jade", [sfBuilderProvider.builders.sfField, sfBuilderProvider.builders.ngModel, layoutBuilder.builder, sfBuilderProvider.builders.condition, sfBuilderProvider.builders.transclusion]);
	    }])
	    .run(["$templateCache", "autoCompleteBuilder", function ($templateCache) {
	        $templateCache.put('./decorators/jsoneditor.jade', __webpack_require__(52)());
	        $templateCache.put('./decorators/card.jade', __webpack_require__(53)());
	        $templateCache.put('./decorators/autocomplete-1.jade', __webpack_require__(54)());
	        $templateCache.put('./decorators/section-1.jade', __webpack_require__(55)());
	        $templateCache.put('./decorators/querytable.jade', __webpack_require__(56)());
	        $templateCache.put('./decorators/modandact.jade', __webpack_require__(279)());
	    }]);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-input-container sf-field md-is-error=\"ngModel.$invalid &amp;&amp; ngModel.$dirty\" class=\"schema-form-modandact {{form.htmlClass}}\">");
...
//# sourceMappingURL=0.060c79204ed93ebeddc7.hot-update.js.map