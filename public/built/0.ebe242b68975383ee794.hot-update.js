	    ...
	    Provider.prototype.doAction = function (key, queryData, $form) {
	        ...
	        return this.getModel(key).then(function (aModel) {
	            ...
	            _.each(actionModel.interfaces, function (interfaceModel) {
	                ...
	                var idFieldPaths = !_.isArray(interfaceModel.idFieldPath) ? ["/id"] : interfaceModel.idFieldPath;
	                _.each(idFieldPaths, function (field) {
	                    ...
	                    restAngular.all(pointer.get(queryDataCline, field));
	                });
...
//# sourceMappingURL=0.ebe242b68975383ee794.hot-update.js.map