...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils, $mdDialog, materialUtils) {
	        ...
	        this.topToolbars.push(this.toolbarUtils.btnBuilder("清空所有选中数据", "md-icon-button", false).iconBuilder("clear_all", {}).conditionBuilder("qtCtl.clientData.rows.length").btnClick(function ($event, item, index) {
...
//# sourceMappingURL=0.8999f2c791cc57d3230e.hot-update.js.map