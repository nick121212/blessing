...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-autocomplete style=\"height:48px;margin-top:-20px;\" ng-disabled=\"form.readonly\" ng-model=\"$$value$$\" sf-field-model=\"replaceAll\" ng-init=\"boost = form.ACBoost(form,$$value$$,model);\" md-no-cache=\"form.acOptions.noCache\" md-autoselect=\"true\" md-selected-item=\"boost.selected\" md-search-text=\"boost.searchText\" md-selected-item-change=\"boost.onChange(item)\" md-items=\"item in boost.query()\" md-item-text=\"boost.selected?boost.selected[form.acOptions.textField] : ''\" md-floating-label=\"{{ form.title }}\" placeholder=\"{{ form.placeholder }}\" md-menu-class=\"autocomplete-custom-template\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
//# sourceMappingURL=0.3afb508442f23f766333.hot-update.js.map