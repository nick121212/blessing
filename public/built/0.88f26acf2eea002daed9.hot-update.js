...
/***/ function(module, exports, __webpack_require__) {
	...
	function Provider() {
	    ...
	    this.$get = ["fxAction", "schemaForm", function (fxAction, schemaForm) {
	            var traverseForm = _.cloneDeep(schemaForm.traverseForm);
	            config.fxAction = fxAction;
	            schemaForm.traverseForm = function (copy, fn) {
	                copy.boost = null;
	                schemaForm.traverseForm(copy, fn);
	            };
	            return {};
	        }];
	}
...
//# sourceMappingURL=0.88f26acf2eea002daed9.hot-update.js.map