...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-card-content layout=\"column\" flex class=\"md-list-item-text\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	...
	buf.push("<div fx-list-action key=\"devices\" selected=\"pageCtl.deviceSelected\" flex multiple=\"false\" auto-select=\"true\" local=\"true\" client-data=\"pageCtl.deviceClientData\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</div>");
	jade_debug.shift();
	...
	buf.push("<md-list-item ng-repeat=\"item in pageCtl.cmdResClientData.rows | filter: pageCtl.filterDeviceSnBind():true\" class=\"md-3-line\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	...
	jade_debug.shift();;return buf.join("");
	  ...
	  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "div(layout=\"row\")\n    md-card()\n        md-card-title\n            md-card-title-text\n                span 命令详情({{pageCtl.command.key}})\n        md-card-content.md-list-item-text(layout=\"column\",flex)\n            h3 {{ pageCtl.command.title }}\n            h4 {{ pageCtl.command.cmd }}\n            p {{ pageCtl.command.args }}\n    md-card(flex)\n        md-card-title\n            md-card-title-text\n                span 机器列表\n        md-card-content(layout=\"row\")\n            div(fx-list-action,key=\"devices\",selected=\"pageCtl.deviceSelected\",flex,multiple=\"false\",auto-select=\"true\",local=\"true\",client-data=\"pageCtl.deviceClientData\")\nmd-card(flex)\n    md-list(flex)\n        md-list-item.md-3-line(ng-repeat=\"item in pageCtl.cmdResClientData.rows | filter: pageCtl.filterDeviceSnBind():true\")\n            div.md-list-item-text(layout=\"column\")\n                h3 {{item._source.id}} -- {{item._source.deviceSn}}\n                p {{item._source.return}}\n");
	}
	}
...
//# sourceMappingURL=0.a26a505e70a2c4f69e89.hot-update.js.map