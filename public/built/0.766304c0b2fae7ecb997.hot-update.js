	                        ...
	                        _this.socket.emit('ack', crawler, function (result) {
	                            if (result.ret === 0) {
	                                if (result.showResult) {
	                                    return _this.fxAction.getModel("crawlerSettingAckAction").then(function (actionModel) {
	                                        _this.fxAction.doActionModel($event, actionModel, result.data, function () {
...
//# sourceMappingURL=0.766304c0b2fae7ecb997.hot-update.js.map