...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction) {
	        ...
	        formWithIndex = _.filter(formWithIndex.items, function (item) {
	            return item.key.join('') === $scope.form.key.join('');
	        });
	        $scope.boost = new Builder($scope.form, fxAction);
	        onChange = $scope.boost.onChange;
	        $scope.boost.onChange = function (item, form) {
	            onChange(item, form);
...
//# sourceMappingURL=0.20552a3c35ccdf9d880d.hot-update.js.map