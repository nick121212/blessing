	...
	var Force = (function () {
	    function Force(select, nodes, links) {
	        ...
	        _.each(this.links, function (link) {
	            link.source = _this.nodes[link.source] || (_this.nodes[link.source] = { name: link.source });
	            link.target = _this.nodes[link.target] || (_this.nodes[link.target] = { name: link.target });
	        });
	    }
	    return Force;
	}());
...
//# sourceMappingURL=0.f5ebc406d0c5096bed94.hot-update.js.map