...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils) {
	        ...
	        this.itemToolbars.push(this.toolbarUtils.btnBuilder("删除", "md-icon-button", false).iconBuilder("delete", {}).btnClick(function ($event) {
	            alert(1);
	        }).toValue());
	    }
	    return Controller;
...
//# sourceMappingURL=0.c5e67715028d7423fc9e.hot-update.js.map