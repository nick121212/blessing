	...
	var TtyController = (function () {
	    function TtyController($scope, $stateParams, toolbarUtils, materialUtils, fxAction) {
	        ...
	        this.toolbar_logs = [
	            ...
	            this.toolbarUtils.btnBuilder("clear", "md-icon-button", false).iconBuilder("clear").btnClick(function ($event) {
	                _this.logs.length = 0;
	            }).toValue(),
...
//# sourceMappingURL=0.f4e82eb04e2e9b163c8b.hot-update.js.map