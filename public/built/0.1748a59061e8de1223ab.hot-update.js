...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils) {
	        ...
	        this.toolbars.push(this.toolbarUtils.btnBuilder("删除", "md-fab md-raised md-mini", false).iconBuilder("{{qtCtl.layout=='column'?'format-vertical-align-center':'format-horizontal-align-center'}}", {}).btnClick(function ($event, item, index) {
...
//# sourceMappingURL=0.1748a59061e8de1223ab.hot-update.js.map