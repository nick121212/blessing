	...
	var Controller = (function () {
	    ...
	    Controller.prototype.initToolbar = function () {
	        ...
	        this.toolbars = [
	            ...
	            this.toolbarUtils.btnBuilder("完成", "md-primary", true, "top").iconBuilder("done_all").conditionBuilder("wizardCtl.selectedIndex===wizardCtl.actionModel.wizard.actions.length-1", false).btnClick(function ($event) {
...
//# sourceMappingURL=0.28f7b235447a70dd0fc4.hot-update.js.map