...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-sidenav md-component-id=\"executeCmdRight\" layout=\"column\" md-whiteframe=\"4\" md-is-open=\"executeCmdCtl.isOpen\" class=\"md-sidenav-right sidenav-{{executeCmdCtl.size||80}}\">");
	...
	buf.push("{{item._source.id}} -- {{item._source.monionid}} -- {{item._source.deviceSn}}");
	jade_debug.shift();
	jade_debug.shift();
	buf.push("</h2>");
	jade_debug.shift();
...
//# sourceMappingURL=0.78c2dbd5b46a04e80d2e.hot-update.js.map