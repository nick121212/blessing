...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageExecuteCmdResultController = (function () {
	    ...
	    PageExecuteCmdResultController.prototype.getCommandResult = function (cmdId) {
	        this.fxAction.doAction("executeCmdList", { where: { "query": { "and": [{ "match": { "_id": cmdId } }] } } }).then(function (res) {
	            console.log(res);
	        });
	    };
	...
	var PageExecuteCmdController = (function () {
	    function PageExecuteCmdController($rootScope, $stateParams, $timeout, materilUtils, fxAction, toolbarUtils) {
	        ...
	        $timeout(function () {
	            _this.$rootScope.$broadcast("showExecuteCmdResult", "4d1b57ea-68cc-40c3-b053-808c44dc1d3a");
	            _this.isOpen = true;
	        }, 2000);
	    }
...
//# sourceMappingURL=0.85d2f0ddbae29b5cc852.hot-update.js.map