...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-autocomplete style=\"height:48px;margin-top:-47px;\" ng-disabled=\"form.readonly\" md-no-cache=\"form.acOptions.noCache\" md-autoselect=\"true\" md-delay=\"300\" ng-model=\"$$value$$\" sf-field-model sf-changed=\"form\" schema-validate=\"form\" md-selected-item=\"boost.selected\" md-search-text=\"boost.searchText\" md-selected-item-change=\"boost.onChange(item)\" md-items=\"item in boost.query()\" md-item-text=\"item[form.acOptions.textField]\" md-floating-label=\"{{ form.title }}\" placeholder=\"{{ form.placeholder }}\" md-menu-class=\"autocomplete-custom-template\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
//# sourceMappingURL=0.2d2f673cf7f601f19b6a.hot-update.js.map