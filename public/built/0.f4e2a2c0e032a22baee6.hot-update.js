...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils) {
	        ...
	        this.itemToolbars = [
	            this.toolbarUtils.btnBuilder("删除", "md-icon-button", false).iconBuilder("delete", { fill: "black" }).btnClick(function ($event) {
	            }).toValue()
	        ];
	    }
	    return Controller;
...
//# sourceMappingURL=0.f4e2a2c0e032a22baee6.hot-update.js.map