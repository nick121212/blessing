	...
	var Force = (function () {
	    function Force(select, nodes, links) {
	        ...
	        _.each(this.links, function (link) {
	            link.source = covNodes[link.source] || (covNodes[link.source] = { name: link.source });
	            link.target = covNodes[link.target] || (covNodes[link.target] = { name: link.target });
	        });
	        ...
	        var path = svg.append("g").selectAll("path")
	            .data(this.simulation.force("links"))
	            .enter().append("path")
...
//# sourceMappingURL=0.ce89838767b6a3f5aa10.hot-update.js.map