	    ...
	    Provider.prototype.getSchema = function (actionModel) {
	        ...
	        if (keys.length) {
	            this.getModel("schemaListAction").then(function (model) {
	                ...
	                if (actionModel.type === action_model_1.ActionType.form) {
	                    _.isString(actionModel.form.dataSchema) && (actionModel.form.dataSchema = schemas[actionModel.form.dataSchema]);
	                    _.isString(actionModel.form.formSchema) && (actionModel.form.formSchema = schemas[actionModel.form.formSchema]);
	                }
	                console.log(data);
	            }).finally(function () {
...
//# sourceMappingURL=0.d8d2afb7aeaab0dd02b1.hot-update.js.map