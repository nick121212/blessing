...
/***/ function(module, exports) {
	...
	var LoginController = (function () {
	    function LoginController($rootScope, fxAction, materialUtils) {
	    ...
	    LoginController.prototype.doSubmit = function ($form) {
	        ...
	        promise && promise.then(function (user) {
	            ...
	            _this.$state.go("home");
	            _this.$rootScope['user'] = user.name;
	        });
	    };
	    LoginController.$inject = ["$rootScope", "fxAction", "materialUtils"];
...
//# sourceMappingURL=0.c6cdc4f5500668c78de6.hot-update.js.map