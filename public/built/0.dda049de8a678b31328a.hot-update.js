...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-input-container ng-init=\"boost=null;\" sf-layout md-is-error=\"ngModel.$error &amp;&amp; ngModel.$invalid &amp;&amp; ngModel.$dirty\" class=\"schema-form-autocomplete {{form.htmlClass}}\">");
	...
	buf.push("<md-autocomplete style=\"height:48px;margin-top:-20px;\" ng-disabled=\"form.readonly\" ng-model=\"$$value$$\" sf-field-model=\"replaceAll\" ng-init=\"boost = form.ACBoost(form,$$value$$,model);\" md-no-cache=\"form.acOptions.noCache\" md-autoselect=\"true\" md-selected-item=\"boost.selected\" md-search-text=\"boost.searchText\" md-selected-item-change=\"boost.onChange(item)\" md-items=\"item in boost.query()\" md-item-text=\"boost.selected[form.acOptions.textField]\" md-floating-label=\"{{ form.title }}\" placeholder=\"{{ form.placeholder }}\" md-menu-class=\"autocomplete-custom-template\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	...
	buf.push("{{ boost.selected[form.acOptions.textField] }}");
	jade_debug.shift();
	jade_debug.shift();
	buf.push("</span>");
	jade_debug.shift();
	...
	buf.push("{{ !$first ? (form.acOptions.prefix || '-'):'' }} {{ boost.selected[form.acOptions.textField] }}");
	jade_debug.shift();
	jade_debug.shift();
	buf.push("</span>");
	jade_debug.shift();
...
//# sourceMappingURL=0.dda049de8a678b31328a.hot-update.js.map