	            ...
	            _.each(actionModel.interfaces, function (interfaceModel) {
	                ...
	                switch (interfaceModel.method) {
	                    case interface_model_1.MethodType.POST:
	                        promise = restAngular.post(queryDataCline, params, headers);
	                        break;
	                    case interface_model_1.MethodType.GET:
	                        promise = restAngular.customGET(_.extend({}, params, interfaceModel.params ? pointer.get(queryDataCline, interfaceModel.idFieldPath) : null), queryDataCline, headers);
	                        break;
	                    case interface_model_1.MethodType.PUT:
	                        promise = restAngular.customPUT(_.extend({}, params, _.isObject(queryDataCline) ? queryDataCline : null), pointer.get(queryDataCline, interfaceModel.idFieldPath), headers);
	                        break;
...
//# sourceMappingURL=0.f413589d88afc7673ced.hot-update.js.map