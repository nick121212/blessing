	...
	var Force = (function () {
	    ...
	    Force.prototype.doZoom = function () {
	        ...
	        this.zoom = d3.zoom()
	            ...
	            _this.svgEdges.attr("transform", d3.event.transform);
	        });
	        this.container.call(this.zoom);
	    };
	    Force.prototype.doDrawEdges = function () {
	        this.svgEdges = this.container.append("svg").append("g")
	            .attr("class", "lines")
	            .selectAll("line")
	            .data(this.links)
	            .enter()
...
//# sourceMappingURL=0.3376cbda17b307d4741f.hot-update.js.map