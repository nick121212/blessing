	        ...
	        var actionModel = {
	            ...
	            list: {
	                columns: [
	                    ...
	                    actionUtils.columnBuilder("<span>{{::item.type}}</span>", "分组名称", "group").toValue(),
	                    actionUtils.columnBuilder("<span>{{ ::item.title }}</span>", "模块类型").toValue()
	                ],
	                queryData: { limit: 50 },
	                showPagination: true,
	    ...
	    function Search() {
	        var actionModel = {
	            ...
	            form: {
	                ...
	                formSchema: "actionSearchActionData"
	            }
	        };
	        return actionModel;
	    }
...
//# sourceMappingURL=0.dd647b372929087e79e6.hot-update.js.map