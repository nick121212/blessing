	        ...
	        if (promise) {
	            ...
	            promise.then(function (res) {
	                ...
	                return _this.fxAction.getModel("resultAction").then(function (actionModelResult) {
	                    _this.fxAction.doActionModel($event, actionModelResult, { return: _this.executeResult.queueItem }, function () {
	                    });
	                });
	            }).finally(function () {
	                _this.isBusy = false;
...
//# sourceMappingURL=0.c5b3322f593fa9ab4a1c.hot-update.js.map