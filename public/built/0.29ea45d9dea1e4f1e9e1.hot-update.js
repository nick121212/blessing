...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div fx-list-action key=\"devices\" flex multiple=\"false\" auto-select=\"true\" local=\"true\" client-data=\"pageCtl.cmdClientData.rows[0]._source.listip\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</div>");
	jade_debug.shift();
	...
	jade_debug.shift();;return buf.join("");
	  ...
	  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "md-content(flex,layout=\"column\")\n    md-card()\n        md-card-title\n            h1 命令详情\n        md-card-content\n            h1 hello \n    md-card\n        md-card-title\n            h1 机器列表\n        md-card-content\n            div(fx-list-action,key=\"devices\",flex,multiple=\"false\",auto-select=\"true\",local=\"true\",client-data=\"pageCtl.cmdClientData.rows[0]._source.listip\")");
	}
	}
...
//# sourceMappingURL=0.29ea45d9dea1e4f1e9e1.hot-update.js.map