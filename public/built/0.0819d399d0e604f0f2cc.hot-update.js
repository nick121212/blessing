	    ...
	    Controller.prototype.getActionModel = function () {
	        ...
	        this.fxAction.getModel(this.key).then(function (actionModel) {
	            if (actionModel.type === action_model_1.ActionType.form && actionModel.form) {
	                if (pointer.has(_this.formData, actionModel.form.path || "")) {
	                    _this.formData = pointer.get(_this.formData, actionModel.form.path || "");
	                }
	            }
...
//# sourceMappingURL=0.0819d399d0e604f0f2cc.hot-update.js.map