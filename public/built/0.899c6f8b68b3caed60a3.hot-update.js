	            ...
	            _.forEach(actionModels, function (actionModel, key) {
	                ...
	                switch (actionModel.type) {
	                    ...
	                    case action_model_1.ActionType.confirm:
	                        ...
	                        _this.tools.push(_this.toolbarUtils.btnBuilder("清空搜索条件", "md-icon-button", false).iconBuilder("clear_all").btnClick(function ($event) {
	                        }).toValue());
...
//# sourceMappingURL=0.899c6f8b68b3caed60a3.hot-update.js.map