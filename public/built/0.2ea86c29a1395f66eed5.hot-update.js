...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-button ng-click=\"sideCtl.doLinkPre($event,node)\" md-style-color=\"{'background-color': sideCtl.isSelected(node) ? 'warn.300': 'primary.0','color':sideCtl.isSelected(node)?'primary.300':'background.300'}\" class=\"layout-fill\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
//# sourceMappingURL=0.2ea86c29a1395f66eed5.hot-update.js.map