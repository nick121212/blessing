	            ...
	            this.ngModel.$parsers.push(function (value) {
	                ...
	                if (_this.form.acOptions.keyField) {
	                    if (pointer.has(value, "/" + _this.form.acOptions.keyField)) {
	                        _this.ngModel.$setViewValue(pointer.get(value, "/" + _this.form.acOptions.keyField));
	                    }
	                    else {
	                        console.error("autocomplete-1-\u6CA1\u6709\u5728item\u4E2D\u627E\u5230" + _this.form.acOptions.keyField);
	                        pointer.remove(_this.formData, "/" + _this.form.key.join('/'));
	                    }
	                }
	                return value;
	            });
...
//# sourceMappingURL=0.d0adb6a01919e42fd84a.hot-update.js.map