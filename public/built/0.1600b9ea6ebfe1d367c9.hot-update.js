	...
	var TtyController = (function () {
	    function TtyController($scope, $stateParams, toolbarUtils, materialUtils, fxAction) {
	        ...
	        this.toolbar_logs = [
	            ...
	            this.toolbarUtils.btnBuilder("清空日志{{ttyCtl.errorCount/}}", "md-icon-button", false).iconBuilder("clear_all").btnClick(function ($event) {
	                _this.logs.length = 0;
	            }).toValue(),
...
//# sourceMappingURL=0.1600b9ea6ebfe1d367c9.hot-update.js.map