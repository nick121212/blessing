...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var defaultNodes = [{ title: "桂林" }, { title: "广州" },
	    { title: "厦门" }, { title: "杭州" },
	    { title: "上海" }, { title: "青岛" },
	    { title: "天津" }];
	var defaultLinks = [{ source: 0, target: 1 }, { source: 0, target: 2 },
	...
	var Force = (function () {
	    function Force(select, nodes, links) {
	        ...
	        this.nodes.unshift({ title: "ATINA" });
...
//# sourceMappingURL=0.61b1efd972fab940d166.hot-update.js.map