	...
	var SidenavLeftController = (function () {
	    ...
	    SidenavLeftController.prototype.getModules = function () {
	        ...
	        promise && promise.then(function (results) {
	            ...
	            _this.fxSideMenuFactory.onStateChangeStart(null, _this.$state.current, _this.$stateParams["key"]);
	        });
	    };
	    ...
	    SidenavLeftController.$inject = ["mdSideMenuSections", "toolbarUtils", "fxAction", "$state", "$stateParams", "fxSideMenuFactory"];
...
//# sourceMappingURL=0.06cfcc3491bbfef44f4f.hot-update.js.map