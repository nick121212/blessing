...
/***/ function(module, exports, __webpack_require__) {
	...
	function Provider() {
	    ...
	    this.builder = function (args) {
	        ...
	        args.form.boost = new Builder(args.form);
	    };
	    this.$get = ["fxAction", "schemaForm", function (fxAction, schemaForm) {
	            var traverseForm = schemaForm.traverseForm;
	            config.fxAction = fxAction;
	            schemaForm.traverseForm = function (copy, fn) {
	                if (copy.boost) {
	                    copy.boost = null;
	                    copy.boost = new Builder(copy, copy.arrayIndex);
	                }
	                traverseForm(copy, fn);
	            };
	            return {};
	        }];
	}
...
//# sourceMappingURL=0.25f01c35699e47a41659.hot-update.js.map