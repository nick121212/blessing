	        ...
	        if (promise) {
	            ...
	            promise.then(function (res) {
	                ...
	                return _this.fxAction.getModel("resultAction").then(function (actionModelResult) {
	                    _this.fxAction.doActionModel($event, actionModelResult, { data: _this.executeResult.queueItem }, function () {
	                    });
	                });
	            }).finally(function () {
	                _this.isBusy = false;
...
//# sourceMappingURL=0.167ea725fb20a28b784c.hot-update.js.map