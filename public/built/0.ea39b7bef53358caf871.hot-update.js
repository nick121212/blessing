...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-button ng-click=\"sideCtl.doLinkPre($event,node)\" md-style-color=\"{'background-color': sideCtl.isSelected(node) ? 'warn.300': 'primary.0','color':sideCtl.isSelected(node)?'background.A300':'background.900'}\" class=\"layout-fill\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	...
	buf.push("<ng-md-icon icon=\"{{ node.icon||'apps'}}\" md-style-color=\"{'fill':sideCtl.isSelected(node)?'background.A300':'background.900'}\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</ng-md-icon>");
	jade_debug.shift();
...
//# sourceMappingURL=0.ea39b7bef53358caf871.hot-update.js.map