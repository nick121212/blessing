...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = (function () {
	    function Controller($scope, fxAction, toolbarUtils, $mdDialog, materialUtils) {
	        ...
	        this.topToolbars.push(this.toolbarUtils.btnBuilder("清空所有选中数据", "md-icon-button", false).iconBuilder("clear_all", {}).conditionBuilder("listCtl.qtCtl.clientData.rows.length", false).btnClick(function ($event, item, index) {
...
//# sourceMappingURL=0.0d377b09db4c2701f918.hot-update.js.map