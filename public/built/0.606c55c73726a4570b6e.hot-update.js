...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-button ng-click=\"sideCtl.doLinkPre($event,node)\" md-style-color=\"{'background-color': sideCtl.isSelected(node) ? 'warn.300': 'primary.0','color':sideCtl.isSelected(node)?'background.300':'background.300'}\" class=\"layout-fill\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
//# sourceMappingURL=0.606c55c73726a4570b6e.hot-update.js.map