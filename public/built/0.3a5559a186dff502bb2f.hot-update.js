...
/***/ function(module, exports, __webpack_require__) {
	...
	var D3Controller = (function () {
	    ...
	    D3Controller.prototype.doTrans = function () {
	        links.pop();
	        nodes.pop();
	        var exit = this.link.data(links);
	        var exit1 = this.node.data(nodes);
	        this.simulation.clear().restart();
	        exit.remove();
	        exit1.remove();
	    };
	    D3Controller.prototype.drawSuits = function () {
	        ...
	        var link = this.link = svg.append("g")
	            .attr("class", "links")
	            .selectAll("line")
	            .data(links)
	            .enter()
	        ...
	        var dragFunc = d3.drag()
	            ...
	            .on("drag", dragged)
	            .on("end", dragended);
	        var node = this.node = svg.append("g")
	            .attr("class", "nodes")
	            .selectAll("circle")
	            .data(nodes)
	            .enter()
...
//# sourceMappingURL=0.3a5559a186dff502bb2f.hot-update.js.map