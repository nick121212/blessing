	    ...
	    $stateProvider.state("home.page", {
	        ...
	        views: {
	            "content": {
	                ...
	                controllerAs: "pageCtl",
	                template: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./tpls/page.execute.cmd.jade\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))()
	            }
	        }
	    }).state('home.qt', {
	        url: "qt",
...
/***/ function(module, exports) {
	...
	var PageExecuteCmdController = (function () {
	    function PageExecuteCmdController($stateParams) {
	        this.$stateParams = $stateParams;
	        this.key = $stateParams["key"];
	    }
	    PageExecuteCmdController.$inject = ["$stateParams"];
...
//# sourceMappingURL=0.f9859772f5c0804a6ee9.hot-update.js.map