	...
	var Force = (function () {
	    ...
	    Force.prototype.doZoom = function () {
	        ...
	        this.zoom = d3.zoom()
	            ...
	            .duration(400)
	            .on("zoom", function () {
	            _this.container.style("transform", "scale(" + d3.event.transform.k + ") translate(" + d3.event.transform.x + "," + d3.event.transform.y + ")");
	        });
...
//# sourceMappingURL=0.d109ccff83869e5b21bb.hot-update.js.map