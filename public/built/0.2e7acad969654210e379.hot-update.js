	...
	var TtyController = (function () {
	    function TtyController($scope, $stateParams, toolbarUtils, materialUtils, fxAction) {
	        ...
	        this.toolbar_logs = [
	            ...
	            this.toolbarUtils.btnBuilder("清空日志{{ttyCtl.errorCount/(this.logs.length||1)}}", "md-icon-button", false).iconBuilder("clear_all").btnClick(function ($event) {
	                _this.logs.length = 0;
	            }).toValue(),
...
//# sourceMappingURL=0.2e7acad969654210e379.hot-update.js.map