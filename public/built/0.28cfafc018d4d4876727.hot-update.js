...
/***/ function(module, exports, __webpack_require__) {
	...
	var Builder = (function () {
	    function Builder(form, modelValue, formData) {
	        this.form = form;
	    ...
	    Builder.prototype.onChange = function (item, form) {
	...
	var Controller = (function () {
	    ...
	    Controller.prototype.init = function () {
	        this.$scope.acOptions = _.extend({
	            ...
	            search: "",
	            actionKey: ""
	        }, this.$scope.form.acOptions || {});
	    };
	    Controller.prototype.query = function () {
	        var _this = this;
	        var actionModel, clientData = {};
	        var filter = {};
	        if (this.acOptions.actionKey) {
	            pointer.set(filter, this.acOptions.search, this.searchText);
	            _.forEach(this.acOptions._where, function (val, key) {
	                pointer.set(filter, key, val);
	            });
	            return this.fxAction.getModel(this.acOptions.actionKey).then(function (aModel) {
	                actionModel = aModel;
	                return _this.fxAction.doAction(actionModel.key, filter);
	            }).then(function (results) {
	                return _this.fxAction.doDealResult(actionModel, results, clientData);
	            }).then(function (results) {
	                return results[_this.acOptions.dataField];
	            });
	        }
	        return this.acOptions.data || [];
	    };
...
//# sourceMappingURL=0.28cfafc018d4d4876727.hot-update.js.map