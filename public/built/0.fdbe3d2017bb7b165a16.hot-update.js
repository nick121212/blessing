	    ...
	    var Builder = (function () {
	        ...
	        Builder.prototype.init = function (modelValue) {
	            ...
	            this.ngModel.$parsers.push(function (value) {
	                ...
	                if (_this.form.acOptions.keyField) {
	                    if (pointer.has(value, "/" + _this.form.acOptions.keyField)) {
	                        return _this.ngModel.$setViewValue(pointer.get(value, "/" + _this.form.acOptions.keyField));
	                    }
	                    else {
	                        console.error("autocomplete-1-\u6CA1\u6709\u5728item\u4E2D\u627E\u5230" + _this.form.acOptions.keyField);
	                        return pointer.remove(_this.formData, "/" + _this.form.key.join('/'));
	                    }
	                }
	                return value;
	            });
...
//# sourceMappingURL=0.fdbe3d2017bb7b165a16.hot-update.js.map