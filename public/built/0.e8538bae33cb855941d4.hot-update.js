...
/***/ function(module, exports) {
	...
	var PageExecuteCmdController = (function () {
	    ...
	    PageExecuteCmdController.prototype.doInitToolbar = function () {
	        this.toolbars = [
	            this.toolbarUtils.btnBuilder("{{listCtl.actionModel.list.showSearchPanel?'关闭搜索栏':'打开搜索栏'}}", "md-icon-button", false).iconBuilder("{{listCtl.actionModel.list.showSearchPanel?'window-open':'window-closed'}}", {}).btnClick(function ($event) {
	            }).toValue()
	        ];
	    };
...
//# sourceMappingURL=0.e8538bae33cb855941d4.hot-update.js.map