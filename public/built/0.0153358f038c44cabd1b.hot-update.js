	...
	function Provider() {
	    ...
	    var Builder = (function () {
	        ...
	        Builder.prototype.init = function (form, modelValue, formData) {
	            form.boost = new Builder(form, arrayIndex);
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-autocomplete style=\"height:48px;margin-top:-20px;\" ng-disabled=\"form.readonly\" ng-model=\"$$value$$\" sf-field-model=\"replaceAll\" ng-init=\"form.boost.init(form,$$value$$,model,arrayIndex)\" md-no-cache=\"form.acOptions.noCache\" md-autoselect=\"true\" md-selected-item=\"form.boost.selected\" md-search-text=\"form.boost.searchText\" md-selected-item-change=\"form.boost.onChange(item)\" md-items=\"item in form.boost.query()\" md-item-text=\"item[form.acOptions.textField]\" md-floating-label=\"{{ form.title }}\" placeholder=\"{{ form.placeholder }}\" md-menu-class=\"autocomplete-custom-template\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
//# sourceMappingURL=0.0153358f038c44cabd1b.hot-update.js.map