	...
	var Controller = (function () {
	    ...
	    Controller.prototype.getActionModel = function () {
	        ...
	        this.fxAction.getModel(this.key).then(function (actionModel) {
	            ...
	            return _this.fxAction.doAction(_this.key, _this.formData, null, "open");
	        }).then(function (results) {
	            _this.formData = _this.fxAction.doDealResult(_this.actionModel, results, _this.formData);
...
//# sourceMappingURL=0.cd044ea44b6133ad91c4.hot-update.js.map