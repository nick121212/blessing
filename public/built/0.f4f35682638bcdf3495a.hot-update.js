	            ...
	            this.$scope.$on("socket:events", function (event, msg) {
	                ...
	                if (!_.some(_this.cmdResClientData.rows, function (row) {
	                    ...
	                    _this.$timeout(function () {
	                        ...
	                        var device = _.find(_this.deviceClientData.rows, function (row) {
	                            return row._id == msg._id;
	                        });
	                    }, 1000);
	                }
	    ...
	    PageExecuteCmdResultController.prototype.getCommandResult = function (cmdId) {
	        ...
	        this.$timeout(function () {
	            ...
	            _this.$q.all([
	                ...
	                _this.realTime ? function () { } : _this.fxAction.doAction("executeCmdResList", { where: { "query": { "and": [{ "match": { "jid": cmdId } }] } } })
...
//# sourceMappingURL=0.f4f35682638bcdf3495a.hot-update.js.map