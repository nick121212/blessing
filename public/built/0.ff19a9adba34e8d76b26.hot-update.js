...
/***/ function(module, exports) {
	...
	var PageExecuteCmdController = (function () {
	    ...
	    PageExecuteCmdController.prototype.doInitToolbar = function () {
	        this.toolbars = [
	            this.toolbarUtils.labelBuilder("执行命令", "md-icon-button", false).iconBuilder("apple-keyboard-command", {}).btnClick(function ($event) {
	            }).toValue()
	        ];
	    };
...
//# sourceMappingURL=0.ff19a9adba34e8d76b26.hot-update.js.map