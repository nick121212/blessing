	...
	var D3Controller = (function () {
	    ...
	    D3Controller.prototype.drawSuits = function () {
	        ...
	        var zoom = d3.zoom()
	            ...
	            .on("zoom", function () {
	            var transform = d3.event.transform;
	            d3.event.sourceEvent.currentTarget.style("transform", "translate(" + transform.x + "px," + transform.y + "px) scale(" + transform.k + ")")
	                .style("transform-origin", d3.event.sourceEvent.pageX + "px " + d3.event.sourceEvent.pageY + "px");
	        });
...
//# sourceMappingURL=0.fce0f922ebb700f21c7e.hot-update.js.map