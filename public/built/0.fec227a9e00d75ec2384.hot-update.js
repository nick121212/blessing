	...
	function Provider() {
	    ...
	    var Builder = (function () {
	        ...
	        Builder.prototype.init = function (modelValue) {
	            ...
	            this.ngModel.$setViewValue({ key: "test11", description: "test11" });
	        };
	    ...
	    this.builder = function (args) {
	        ...
	        args.form.ACBoost = function (form, modelValue, formData, ngModel, $index) {
	            console.log(args);
...
//# sourceMappingURL=0.fec227a9e00d75ec2384.hot-update.js.map