	    ...
	    Provider.prototype.getSchema = function (actionModel) {
	        ...
	        if (keys.length) {
	            this.getModel("schemaListAction").then(function (model) {
	                ...
	                if (actionModel.type === action_model_1.ActionType.form) {
	                    _.isString(actionModel.form.dataSchema) && schemas[actionModel.form.dataSchema] && (actionModel.form.dataSchema = schemas[actionModel.form.dataSchema]["text"]);
	                    _.isString(actionModel.form.formSchema) && schemas[actionModel.form.formSchema] && (actionModel.form.formSchema = schemas[actionModel.form.formSchema]["textForm"]);
	                }
	            }).finally(function () {
...
//# sourceMappingURL=0.2902c873657eadbc97a5.hot-update.js.map