...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<md-sidenav md-component-id=\"executeCmdRight\" md-disable-backdrop md-whiteframe=\"4\" md-is-open=\"pageCtl.isOpen\" class=\"md-sidenav-right\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.unshift(new jade.DebugItem( 4, "/srv/blessing/public/src/pages/page/tpls/page.execute.cmd.jade" ));
	buf.push("<md-content flex layout=\"row\" fx-query-table=\"devices\">");
	jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
	jade_debug.shift();
	buf.push("</md-content>");
	jade_debug.shift();
	...
	jade_debug.shift();;return buf.join("");
	  ...
	  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "h1 djklfajlkdjflkaj\nmd-button(ng-click=\"pageCtl.showSivenav()\") a\nmd-sidenav.md-sidenav-right(md-component-id=\"executeCmdRight\",md-disable-backdrop,md-whiteframe=\"4\",md-is-open=\"pageCtl.isOpen\")\n    md-content(flex,layout=\"row\",fx-query-table=\"devices\")");
	}
	}
...
//# sourceMappingURL=0.d5b0f10041ab0e7dd0ba.hot-update.js.map