...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageExecuteCmdController = (function () {
	    function PageExecuteCmdController($stateParams, materilUtils, fxAction, toolbarUtils, $websocket, socketFactory) {
	    ...
	    PageExecuteCmdController.prototype.initSocket = function () {
	        var dataStream = this.$websocket("ws://localhost/events");
	        var socket = new WebSocket("ws://127.0.0.1/events");
	        var socketFactory = this.socketFactory("http://localhost:3000/events");
	    ...
	    PageExecuteCmdController.$inject = ["$stateParams", "materialUtils", "fxAction", "toolbarUtils", "$websocket", "socketFactory"];
...
//# sourceMappingURL=0.abcde28867d74c1a9615.hot-update.js.map