...
/***/ function(module, exports, __webpack_require__) {
	...
	var D3Controller = (function () {
	    ...
	    D3Controller.prototype.doGetData = function () {
	        var _this = this;
	        var promise = this.fxAction.doAction(this.key, {});
	        var clientData = {};
	        if (!promise) {
	            return;
	        }
	        ...
	        promise.then(function (result) {
	            _this.fxAction.doDealResult(_this.actionModel, result, clientData);
	        }).finally(function () {
	            _this.isBusy = false;
	        });
	    };
...
//# sourceMappingURL=0.7665bbd5df967f63e80d.hot-update.js.map