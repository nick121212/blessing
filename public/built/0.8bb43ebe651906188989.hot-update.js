	...
	var Force = (function () {
	    ...
	    Force.prototype.doZoom = function () {
	        ...
	        this.zoom = d3.zoom()
	            ...
	            .duration(400)
	            .on("zoom", function () {
	            _this.container.style("transform", "scale(" + d3.event.transform.k + ") translate(" + d3.event.transform.x + "px," + d3.event.transform.y + "px)");
	        });
...
//# sourceMappingURL=0.8bb43ebe651906188989.hot-update.js.map